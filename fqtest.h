...
int testpromotecoflows(struct Qdisc *sch, struct fq_sched_data *q )
{
    ...
    struct fq_flow_head* coFlowsheadptr = &coFlowshead;
    
    struct fq_flow_head* newFlowsheadptr = &newFlowshead;
    
    struct fq_flow_head* oldFlowsheadptr = &oldFlowshead;
 ...
 //singleton case as unit test
   ...
   struct fq_flow* coflowptr = &coflow;
...
int promoteflowstest = testpromotecoflows(sch,q);
